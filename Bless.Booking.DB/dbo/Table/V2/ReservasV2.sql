CREATE TABLE [dbo].[ReservasV2]
(
	ReservaId INT PRIMARY KEY IDENTITY,
    ClienteId INT NOT NULL,
    BarberoId INT NOT NULL,
    ServicioId INT NOT NULL,
    BarberoHorarioAtencionID INT NOT NULL,
    Fecha DATE NOT NULL,
    Hora TIME NOT NULL,
    ...
    FOREIGN KEY (BarberoHorarioAtencionID) REFERENCES BarberoHorarioAtencion(BarberoHorarioAtencionID)
)
